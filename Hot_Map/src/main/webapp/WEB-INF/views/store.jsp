...
<body>
	...
	<div class="container" style="width: 500px">
		<form action="store" method="post">
			...
			이름 :<br /> <input type="text" name="name" class="form-control" required /> <br /> 메뉴 : <input type="text"
				name="menu" class="form-control" /> <br /> 가격 : <input type="text" name="price" class="form-control" />
			<br /> 주소 : <input type="text" name="address" class="form-control" /> <br /> 전화번호 : <input type='tel'
				name="phone" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" placeholder='000-0000-0000'
				class="form-control" /> <br />

			<div class='row'>
				<div class='form-group col-mb-6'>
					<label>오픈 시간</label>
					<input type="time" name="opening_time" placeholder='오픈시간' class="form-control col-mb-6" />
				</div>&nbsp;&nbsp;&nbsp;
				<div class='form-group col-mb-6'>
					<label>마감 시간</label>
